...
export default function (req, res, next) {
  ...
  function XMLResponse () {
    res.send(create(res.bodyXmlObj || res.body, { allowSurrogateChars: true }).end(xmlOpts))
  }
  ...
  function HTMLResponse () {
    ...
    res.render(res.view || 'default', {
      ...
      data: {
        raw: res.body,
        yaml: stringify(res.body, res.yamlInline || 3, 2),

        json: JSON.stringify(res.body, null, 2),

        xml: create(res.bodyXmlObj || res.body, { allowSurrogateChars: true }).end(xmlOpts)
      }
    })
  }
